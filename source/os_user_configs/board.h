 ...
 * PA0  - Digita Input  (Interrupt).
 * PA1  - Digita Outpuit  (RFM75 CE).
 * PA2  - Alternate output  (USART2 TX).
 * PA3  - Normal input      (USART2 RX).
 * PA   - Normal input      (ICU).
 * PA4  - Alternate output  (SPI_NSS).
 * PA5  - Alternate output  (SPI_SCK).
 * PA6  - Alternate output  (SPI_MISO).
 * PA7  - Alternate output  (SPI_MOSI).
 * PA9  - Alternate output  (USART1 TX).
 * PA10 - Normal input      (USART1 RX).
 * PA12 - Alternate output  (USART1 RTS).
 */
#define VAL_GPIOACRL            0xA4AA4B14      /*  PA7...PA0 */
